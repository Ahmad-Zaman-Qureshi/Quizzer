...
s2v = Sense2Vec().from_disk("E:\Quizzer\Quizzer\quizapp\s2v_old")
    ...
    # output= output + ques + "\n" + "Ans: "+answer.capitalize() + "\n\n"
        ...
        if len(distractors)>0:
            for distractor in distractors[4:]:
                output = print("SUMM",distractor)
        else:
            print("End of Distractor")
    #print(lst)
    return lst
#input("Enter paragraph :")
# x = generate_question(context)
# print("mcqs",x)